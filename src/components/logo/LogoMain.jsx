...
import { FaBold, FaHandHoldingMedical } from 'react-icons/fa';
...
function Logo() {
  const logoText = {
    display: 'inline-block', // Align text with the icon
    marginLeft: '8px', // Add space between the icon and the text
    color: '#333' // Customize the text color
  };

  return (
    <div style={{ display: 'flex', alignItems: 'center', padding: '2px' }}>
      <FaHandHoldingMedical size={30} color="#1976d2" /> {/* Icon with size and color */}
      <Typography variant="h6" component="div" sx={logoText} sx={{ fontWeight: 'bold', padding: '15px' }}>
